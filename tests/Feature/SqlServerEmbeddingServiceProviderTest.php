...
use XLaravel\Embedding\Driver\SqlServer\SqlServerPayloadStoreMetrics;
...
class SqlServerEmbeddingServiceProviderTest extends TestCase
{
    ...
    public function test_it_binds_sqlserver_payload_store_metrics(): void
    {
        $this->assertInstanceOf(SqlServerPayloadStoreMetrics::class, app(PayloadStoreMetrics::class));
    }
